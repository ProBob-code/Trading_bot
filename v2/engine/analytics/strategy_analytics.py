...
class StrategyAnalytics:
    ...
    def compute_metrics(self, trades: List[Dict], initial_capital: float = 100000) -> Dict:
        ...
        pnls = [
            float(t.get('pnl') if t.get('pnl') is not None else 
                  t.get('net_pnl') if t.get('net_pnl') is not None else 
    ...
    def update_after_trade(
        ...
        try:
            # Get all closed trades for this strategy (mapped to Institutional Actions)
