...
class ExecutionEngine:
    ...
    def execute_order(
        ...
        """Alias for execute() to match institutional terminology."""
        return self.execute(side, market_price, quantity, volatility, volume, deterministic)
    ...
    def close_position(
        ...
        """Compute fill for closing a position."""
        return self.execute(side, market_price, quantity, volatility, volume, deterministic)
    ...
    def reverse_position(
        ...
        """Compute fill for reversing a position."""
        return self.execute(side, market_price, quantity, volatility, volume, deterministic)
    ...
    def execute(
        ...
        Args:
            ...
            source: 'v1' or 'v2' (Firewall protection)
            
        Returns:
            ExecutionResult with all execution details
        """
        if source == 'v1' and not is_v1_enabled():
            logger.error("BLOCKED: V1 execution attempt via V2 Engine (Firewall Lock)")
            return None
