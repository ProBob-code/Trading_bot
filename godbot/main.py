...
def main():
    ...
    from godbot.db import PaperDB
    from godbot.bot_config import create_default_bots
    from godbot.api import paper_bp, _bots, _get_db
