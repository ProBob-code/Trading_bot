...
def is_v1_enabled() -> bool:
    """
    Check if the V1 legacy engine is enabled.
    By default, it is DISABLED unless ENABLE_V1=true is set in the environment.
    """
    return os.getenv("ENABLE_V1", "false").lower() == "true"
